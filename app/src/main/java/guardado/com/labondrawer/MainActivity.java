package guardado.com.labondrawer;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.contenido,miFragment).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        //Aca sabremos que elemento selecciono
        ...
        //verificamos si se ha seleccionado un item
